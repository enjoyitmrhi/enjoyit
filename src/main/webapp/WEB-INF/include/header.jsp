...
<link rel="stylesheet"
	href="<c:url value= "/resources/bootstrap/css/sb-admin.css" />">


<!-- JS -->
<Script src="<c:url value="/resources/bootstrap/js/sb-admin.min.js" />"></script>
<Script src="<c:url value="/resources/bootstrap/js/bootstrap.min.js" />"></script>

<!-- Custom fonts for this template-->
<link
	href="<c:url value="/resources/bootstrap/vendor/fontawesome-free/css/all.min.css" />"
