		...
		<div id="cuType">
			...
			<form action="#" method="post" name="form1"  >
				<table>
					<tr>
						<td>아이디</td>
						<td><input class="form-control" type="text" name="cuid" id="cuid"></td>
					</tr>
					<tr>
						<td>비밀번호</td>
						<td><input type="password" class="form-control" 
							name="cupw" id="cupw"></td>
		...
		<div id="buType" style="display: none;">
			...
			<form action="#" method="post"  name="form2">
				<table>
					<tr>
						<td>아이디</td>
						<td><input class="form-control" type="text" name="buid" id="buid"></td>


					</tr>
					<tr>
						<td>비밀번호</td>
						<td><input class="form-control" type="password" name="bupw" id="bupw"></td>
