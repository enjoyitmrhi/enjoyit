...
<body>
	...
	<label>아이디</label> <input type="text" name="cuid" id="cuid"><br> 
	...
	<label>생년월일</label>
		...
		<input type="button" value="비밀번호확인"  onclick="showPopup_cu();">
	</form>
	</div>
	...
	<label>아이디</label> <input type="text" name="buid" id="buid"><br> 
	...
	<input type="button" value="비밀번호확인" onclick="showPopup_bu();">
	</form>
	</div>
	
	<input type="radio" name="chk_id" id="cu" 
		onclick="javascript:change_cuMod()" checked="checked" /> 
		<span class="up">일반회원 비밀번호 찾기</span>&nbsp;&nbsp; 
		
	<input type="radio" name="chk_id" id="bu" 
		onclick="javascript:change_buMod()" />
		<span class="up">가맹회원 비밀번호 찾기</span>
	</div>
</body>
</html>