		...
		<form action="joinProc" method="post" name="addjoin" id="addjoin">
			<table class="table">
				<tr>
					...
					<td><input type="button" id="chk_cid"
						onclick="javascript:chk_id()" value="중복확인"></td>
				</tr>
				<tr>
					<td><label><strong>비밀번호*</strong></label></td>

					<td colspan="2"><input type="password" name="cupw" id="cupw">
					</td>

				</tr>
				<tr>
					<td><label><strong>비밀번호 확인*</strong></label></td>
					<td colspan="2"><input type="password" name="cupw2" id="cupw2"></td>

				</tr>
				<tr>
					<td><label><strong>이름*</strong></label></td>
					<td colspan="2"><input type="text" name="cuname" id="cuname"></td>
				...
				<tr style="display: none;">
					...
					<td><input type="text" name="longy" id="longy"
						placeholder="경도"> <input type="text" name="latx" id="latx"
						placeholder="위도"></td>
				</tr>
				<tr>
