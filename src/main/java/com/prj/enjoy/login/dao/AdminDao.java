...
public interface AdminDao {
	...
	public int editProc_cu(String cuid, String cuname, String cuaddr, String cuemail, String cubirth, String cugender, String cutel, String cunum);
	public int editProc_bu(String buid, String buname, String buaddr, String buemail, String burenum, String butel, String bunum);
}
